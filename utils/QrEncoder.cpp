...
int QrEncoder::level() const
{
	return m_nLevel;
}
int QrEncoder::version() const
{
	return m_nVersion;
}
bool QrEncoder::autoExtent() const
{
	return m_bAutoExtent;
}
int QrEncoder::maskingNo() const
{
	return m_nMaskingNo;
}
int QrEncoder::symbleSize() const
{
	return m_nSymbleSize;
}
unsigned char QrEncoder::at(int x, int y)
{
	int X = qBound(0, x, MAX_MODULESIZE - 1);
	int Y = qBound(0, y, MAX_MODULESIZE - 1);
	return m_byModuleData[X][Y];
}
/////////////////////////////////////////////////////////////////////////////
// QrEncoder::encodeData

bool QrEncoder::encodeData(int nLevel, int nVersion, bool bAutoExtent, int nMaskingNo, char* lpsSource, int ncSource)
{
	int i, j;
	...
	int nEncodeVersion = encodeVersion(nVersion, lpsSource, ncLength);
	...
	for (i = 0; i < ncBlock1; ++i)
	{
		...
		rsCodeWord(m_byRSWork, ncDataCw1, ncRSCw1);
	...
	for (i = 0; i < ncBlock2; ++i)
	{
		...
		rsCodeWord(m_byRSWork, ncDataCw2, ncRSCw2);
...
/////////////////////////////////////////////////////////////////////////////
// QrEncoder::encodeVersion

int QrEncoder::encodeVersion(int nVersion, char* lpsSource, int ncLength)
{
...
/////////////////////////////////////////////////////////////////////////////
// QrEncoder::encodeSourceData
bool QrEncoder::encodeSourceData(char* lpsSource, int ncLength, int nVerGroup)
{
	...
	while (nBlock < m_ncDataBlock - 1)
	{
		...
		{
			ncSrcBits = bitLength(m_byBlockMode[nBlock], m_nBlockLength[nBlock], nVerGroup) +
						bitLength(m_byBlockMode[nBlock + 1], m_nBlockLength[nBlock + 1], nVerGroup);

			ncDstBits = bitLength(QR_MODE_ALPHABET, m_nBlockLength[nBlock] + m_nBlockLength[nBlock + 1], nVerGroup);

			if (ncSrcBits > ncDstBits)
			{
				if (nBlock >= 1 && m_byBlockMode[nBlock - 1] == QR_MODE_8BIT)
				{
					ncJoinFront = bitLength(QR_MODE_8BIT, m_nBlockLength[nBlock - 1] + m_nBlockLength[nBlock], nVerGroup) +
								  bitLength(m_byBlockMode[nBlock + 1], m_nBlockLength[nBlock + 1], nVerGroup);

					if (ncJoinFront > ncDstBits + bitLength(QR_MODE_8BIT, m_nBlockLength[nBlock - 1], nVerGroup))
						ncJoinFront = 0; 
				}
				else
					ncJoinFront = 0;
				...
				{
					ncJoinBehind = bitLength(m_byBlockMode[nBlock], m_nBlockLength[nBlock], nVerGroup) +
								   bitLength(QR_MODE_8BIT, m_nBlockLength[nBlock + 1] + m_nBlockLength[nBlock + 2], nVerGroup);

					if (ncJoinBehind > ncDstBits + bitLength(QR_MODE_8BIT, m_nBlockLength[nBlock + 2], nVerGroup))
						ncJoinBehind = 0; 
				}
				else
					ncJoinBehind = 0;
	...
	while (nBlock < m_ncDataBlock - 1)
	{
		...
		ncDstBits = bitLength(QR_MODE_8BIT, m_nBlockLength[nBlock] + m_nBlockLength[nBlock + 1], nVerGroup);
...
int QrEncoder::bitLength(unsigned char nMode, int ncData, int nVerGroup)
{
	int ncBits = 0;
...
/////////////////////////////////////////////////////////////////////////////
// QrEncoder::SetBitStream

int QrEncoder::setBitStream(int nIndex, unsigned short wData, int ncData)
{
	int i;
...
/////////////////////////////////////////////////////////////////////////////
// QrEncoder::isNumeralData

bool QrEncoder::isNumeralData(unsigned char c)
{
	if (c >= '0' && c <= '9')
		return true;
...
/////////////////////////////////////////////////////////////////////////////
// QrEncoder::isAlphabetData

bool QrEncoder::isAlphabetData(unsigned char c)
{
	if (c >= '0' && c <= '9')
		return true;
...
/////////////////////////////////////////////////////////////////////////////
// QrEncoder::isKanjiData

bool QrEncoder::isKanjiData(unsigned char c1, unsigned char c2)
{
...
/////////////////////////////////////////////////////////////////////////////
// QrEncoder::alphabetToBinaly

unsigned char QrEncoder::alphabetToBinaly(unsigned char c)
{
...
/////////////////////////////////////////////////////////////////////////////
// QrEncoder::KanjiToBinaly

unsigned short QrEncoder::kanjiToBinaly(unsigned short wc)
{
...
/////////////////////////////////////////////////////////////////////////////
// QrEncoder::rsCodeWord
void QrEncoder::rsCodeWord(unsigned char * lpbyRSWork, int ncDataCodeWord, int ncRSCodeWord)
{
	int i, j;
...
/////////////////////////////////////////////////////////////////////////////
// QrEncoder::formatModule

void QrEncoder::formatModule()
{
	int i, j;
...
/////////////////////////////////////////////////////////////////////////////
// QrEncoder::setFunctionModule

void QrEncoder::setFunctionModule()
{
	int i, j;
...
/////////////////////////////////////////////////////////////////////////////
// QrEncoder::setFinderPattern

void QrEncoder::setFinderPattern(int x, int y)
{
...
/////////////////////////////////////////////////////////////////////////////
// QrEncoder::setAlignmentPattern

void QrEncoder::setAlignmentPattern(int x, int y)
{
...
/////////////////////////////////////////////////////////////////////////////
// QrEncoder::setVersionPattern

void QrEncoder::setVersionPattern()
{
	int i, j;
...
/////////////////////////////////////////////////////////////////////////////
// QrEncoder::setCodeWordPattern

void QrEncoder::setCodeWordPattern()
{
	int x = m_nSymbleSize;
...
/////////////////////////////////////////////////////////////////////////////
// CQREncode::setMaskingPattern

void QrEncoder::setMaskingPattern(int nPatternNo)
{
	int i, j;
...
/////////////////////////////////////////////////////////////////////////////
// CQREncode::setFormatInfoPattern

void QrEncoder::setFormatInfoPattern(int nPatternNo)
{
	int nFormatInfo;
	int i;
...
/////////////////////////////////////////////////////////////////////////////
// QrEncoder::countPenalty

int QrEncoder::countPenalty()
{
	int nPenalty = 0;
	int i, j, k;
